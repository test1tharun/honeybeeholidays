            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="border-l-4 border-primary pl-3 md:pl-4">
                  <h3 className="text-lg md:text-xl font-semibold mb-1 md:mb-2 text-foreground">Authentic Tamil Cuisine</h3>
                ...
                <div className="border-l-4 border-primary pl-3 md:pl-4">
                  <h3 className="text-lg md:text-xl font-semibold mb-1 md:mb-2 text-foreground">Plantation Life</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
                ...
                <div className="border-l-4 border-primary pl-3 md:pl-4">
                  <h3 className="text-lg md:text-xl font-semibold mb-1 md:mb-2 text-foreground">Regional Festivities</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
