  ...
  return (
    <section id="about" className="py-8 md:py-20 bg-background">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="max-w-4xl mx-auto text-center mb-6 md:mb-12 animate-fade-in">
        ...
        <div className="max-w-5xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
          <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-6 text-center text-foreground">Our Location - Valparai</h3>
