...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-secondary text-secondary-foreground py-8 md:py-12">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="text-center md:text-left">
              <img src={logo} alt="HoneyBee Holidays" className="h-12 md:h-14 mx-auto md:mx-0 mb-4" />
              <p className="text-sm md:text-base text-secondary-foreground/80 mb-4">
            ...
            <div className="text-center">
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-secondary-foreground">Quick Links</h3>
            ...
            <div className="text-center md:text-right">
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-secondary-foreground">Contact Us</h3>
            ...
            <div className="text-center">
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-secondary-foreground">Pay with UPI</h3>
          ...
          <div className="border-t border-secondary-foreground/20 pt-6 md:pt-8 text-center">
            <p className="text-xs md:text-sm text-secondary-foreground/70 mb-2">
